...
# I'm including the core app URLs here
urlpatterns = [
    path("admin/", admin.site.urls),
    path("api/", include('core.api_urls')),  # API endpoints
    path("", include('core.urls')),  # includes all URLs from core/urls.py
...
# Daphne doesn't serve static files automatically like runserver does
if settings.DEBUG:
